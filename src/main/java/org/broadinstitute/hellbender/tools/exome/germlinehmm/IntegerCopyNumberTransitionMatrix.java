 ...
 *     since the interface {@link HiddenMarkovModel} requires the implementation of a single method
 *     {@link HiddenMarkovModel#hiddenStates()}, all targets share the same list of hidden states.
