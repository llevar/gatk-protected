...
public final class AlleleFractionSegmenter extends ScalarHMMSegmenter<AllelicCount> {
    ...
    private final double outlierProbability = AlleleFractionHiddenMarkovModel.DEFAULT_OUTLIER_PROBABILITY;
    ...
    protected ClusteringGenomicHMM<AllelicCount, Double> makeModel() {
        return new AlleleFractionHiddenMarkovModel(getStates(), getMemoryLength());
    }
